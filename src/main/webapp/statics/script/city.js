    ...
    jQuery (function ($)
    {
		...
		hotcity.each (function (i, eleDom)
	    {
		    ...
		    a.click (function ()
		    {
		    	...
		    	siteName.text (txt);//增加名字
		    });
		    if (i == 0)
		    {
		    	console.log(eleDom+'这是eleDom的');
		...
		chars.each (function (i, dom)
		{
			...
			d.each (function (j, eleDom)
			{
				...
				a.click (function ()
				{
					...
					// 				listInfo=listInfo+
					// 					"<a href='' class=\"car-list\">"+
					// 					"<div class=\"car-img\"><img src=\"/statics/images/"+data[i].img+"\" style=\"display:inline\"></div>" +
					// 					"<div class=\"car-des\"><span title=\"${car.name}\">"+data[i].name+"</span>" +
					// 					"<i>三厢 5座 自动 ->"+data[i].city.name+data[i].street.name+"</i></div></a>"
					// 			}
					// 			// 	$.each(data,function(){
					// 			// });
					// 			// #carlistbox
					// 			$("#carlistbox").html(listInfo);
					// 		}
					//
					// 	}
					// });
					// location.href="/carByCity/"+txt;
